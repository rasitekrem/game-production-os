...
> **GPOS template** · `1.0.0-alpha.10` · one record per review · stored where the project keeps review records (e.g. `.game/reviews/`) · see [core/HUMAN-AUTHORITY.md §4](../core/HUMAN-AUTHORITY.md#4-human-review-protocol)
>
