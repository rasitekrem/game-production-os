...
MUTATIONS = [
    ("1 production registry forgets ffprobe", [
        (REGISTRY, PRODUCTION, "(AdbAdapter(), BlenderAdapter(), FfmpegAdapter(), GitAdapter(), UnityAdapter())")]),
    ("2 production registry forgets ffmpeg", [
        (REGISTRY, PRODUCTION, "(AdbAdapter(), BlenderAdapter(), FfprobeAdapter(), GitAdapter(), UnityAdapter())")]),
