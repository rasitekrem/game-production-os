...
Version `1.0.0-alpha.14` · Phase 2C-4 (Blender DCC inspection and visual-evidence adapter) on the frozen Phase-1 core, Phase-2A validator, Phase-2B agent adapter layer, Phase-2C-0 tool adapter foundation, Phase-2C-1 Git provenance adapter, Phase-2C-2 media evidence adapters and Phase-2C-3 Android ADB adapter · all skills `DRAFT`
...
tools/         Tool documentation (production validator, tool adapter foundation, Git, media, ADB and Blender adapters)
gpos/          Validator (2A), agent adapters (2B), tool adapter foundation (2C-0), Git adapter (2C-1), media adapters (2C-2), ADB adapter (2C-3), Blender adapter (2C-4)
...
Semantic Versioning, currently `1.0.0-alpha.14` ([VERSION](VERSION), [CHANGELOG.md](CHANGELOG.md)).
