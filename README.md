...
Version `1.0.0-alpha.15` · Phase 2C-5 (Unity engine adapter, batch plane) on the frozen Phase-1 core, Phase-2A validator, Phase-2B agent adapter layer, Phase-2C-0 tool adapter foundation, Phase-2C-1 Git provenance adapter, Phase-2C-2 media evidence adapters, Phase-2C-3 Android ADB adapter and Phase-2C-4 Blender DCC adapter · all skills `DRAFT`
...
tools/         Tool documentation (production validator, tool adapter foundation, Git, media, ADB, Blender and Unity adapters)
gpos/          Validator (2A), agent adapters (2B), tool adapter foundation (2C-0), Git adapter (2C-1), media adapters (2C-2), ADB adapter (2C-3), Blender adapter (2C-4), Unity adapter (2C-5)
...
Semantic Versioning, currently `1.0.0-alpha.15` ([VERSION](VERSION), [CHANGELOG.md](CHANGELOG.md)).
